...
--
-- Host: 127.0.0.1
-- Generation Time: 12-Jul-2019 às 00:47
...
--
-- Extraindo dados da tabela `giving`
--
...
(1, 'Godfrey', 'Kithinji', 'Mutia', 'Male', '1992-02-24', 'Huruma', 'Meru', 'Praise and Worship', '7391018008', 'godkith@gmail.com', 'uploads/OrientaÃ§Ãµes completas - 06.10.jpg', '$2y$10$YFfWSxvNBV6bLHx88tNgPuKu9BLPP/FkH7cAdv87RBAwdbGz/WdjC', '0725873436', '2017-01-11 11:34:34'),
...
--
-- Extraindo dados da tabela `offering`
--
...
--
-- Extraindo dados da tabela `sundays`
--
...
--
-- Extraindo dados da tabela `teens`
--
...
--
-- Extraindo dados da tabela `tithe`
--
...
(4, '30', '1', '2019-01-19 16:09:48', '0725873436'),
(5, '125', 'ID2', '2019-01-19 16:13:03', '0725873436');
